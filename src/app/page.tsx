...
const perks = [
  ...
  },
  {
    ...
    icon: CheckCircle,
    description: "Every assets on our platform is verified by our team to ensure our highest quality standards."
  },
  {
    name: "For the planet",
    icon: Leaf,
    ...
    <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          Have Fun Shopping at Attractive Prices at{' '}
        ...
        <p className="mt-6 text-lg max-w-prose text-muted-foreground">
          welcome to marketplace from athem. 
          Every assets on our platform is verified by our 
